...
class EditStoryForm extends React.Component {
  ...
  handleSubmit = e => {
      ...
      .then(updatedStory => this.props.updateStoriesPatched(this.props.story, updatedStory)   
    ...
    <form onSubmit={(event) => this.handleSubmit(event)}>
      ...
      {this.state.video && (
        ...
        <label>Content: </label>
        <textarea onChange={this.updateFormData} name='content' value={this.state.content} type="text-area" /><br />
